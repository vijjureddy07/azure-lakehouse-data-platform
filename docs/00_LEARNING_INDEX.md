...
| :--- | :--- | :--- | :--- |
| **Module 1** | **Local PySpark Data Engineering & Data Quality**<br>*(Python, PySpark, Explicit StructType, Ingestion, Transformations, Cleaning, Joins, Window Functions, Spark SQL, Parquet, Data Quality & Quarantine)* | 🟢 **BUILD COMPLETE** | ⏳ **LEARNING PENDING** |
| **Module 2** | **Cloud Ingestion: ADF & ADLS Gen2**<br>*(Azure Data Factory Pipelines, Linked Services, Datasets, ADLS Gen2 Hierarchical Namespace, RBAC, Managed Identity)* | 🟢 **BUILD COMPLETE / DEPLOYMENT READY**<br>*(Cloud Status Factual: Pending)* | ⏳ **LEARNING PENDING** |
| **Module 3** | **Azure Databricks, Delta Lake & Medallion Architecture**<br>*(Unity Catalog 3-Level Namespace, Delta ACID Transactions, Time Travel, Schema Enforcement/Evolution, Bronze / Silver / Gold Medallion Lakehouse, Delta MERGE, Databricks Access Connector)* | 🟢 **BUILD COMPLETE / LOCAL VERIFIED**<br>*(Cloud Status Factual: Pending)* | ⏳ **LEARNING PENDING** |
| **Module 4** | **Advanced PySpark, Dimensional Modeling & Enterprise Data Quality**<br>*(Star Schema, Facts & Dimensions, SCD Type 1 & 2, Point-in-Time Fact Resolution, Enterprise Data Quality Gates, Financial Reconciliation)* | 🟢 **BUILD COMPLETE / LOCAL VERIFIED**<br>*(Cloud Status Factual: Pending)* | ⏳ **LEARNING PENDING** |
| **Module 5** | **Lakeflow Jobs Orchestration + Reliability + Operational Monitoring**<br>*(Lakeflow Jobs Multi-Task DAG, Task Values Communication, Transient vs Deterministic Failure Classification, Idempotent Repair Runs, Operational Run Auditing)* | 🟢 **BUILD COMPLETE / LOCAL VERIFIED**<br>*(Cloud Status Factual: Pending)* | ⏳ **LEARNING PENDING** |
| **Module 6** | **CI/CD, Databricks Bundles & Governed SQL Serving**<br>*(Python Wheel Packaging, Declarative Automation Bundles, GitHub Actions CI, Zero-Secret GitHub OIDC Deployment, Serverless SQL Warehouse, Governed Serving Views)* | 🟢 **BUILD COMPLETE / CI VERIFIED**<br>*(Cloud Status Factual: Pending)* | ⏳ **LEARNING PENDING** |
...
- [09_CICD_BUNDLES_SERVING.md](09_CICD_BUNDLES_SERVING.md): CI/CD release engineering, Python wheel packaging, Declarative Automation Bundles, GitHub OIDC workload identity federation, Serverless SQL Warehouse, and Unity Catalog serving views.
